...
export function initASWebGLue(importObject) {
  // Note: Intentionally using [""] lookups here to avoid name mangling by Google Closure Compiler
  ...
  WebGL["WEBGL_READY"] = false;
  WebGL["memory"] = importObject["env"]["memory"];
  ...
  WebGL["SIZE_OFFSET"] = -4;
  WebGL["ID_OFFSET"] = -8;
  WebGL["CHUNKSIZE"] = 1024;
  WebGL["STRING_ID"] = 1;
  WebGL["RTTI_BASE"] = 0;
  WebGL["VAL_ALIGN_OFFSET"] = 6;
  ...
  WebGL["ARRAYBUFFERVIEW"] = 0x01;
  /** Type is an `Array`. */
  WebGL["ARRAY"] = 0x0002;
  /** Type is a `StaticArray`. */
  WebGL["STATICARRAY"] = 0x0004;
  /** Type is a `Set`. */
  WebGL["SET"] = 0x000008;
  /** Type is a `Map`. */
  WebGL["MAP"] = 0x000010;
  /** Type is inherently acyclic. */
  WebGL["ACYCLIC"] = 0x000020;
  /** Value alignment of 1 byte. */
  WebGL["VALUE_ALIGN_0"] = 0x000040;
  /** Value alignment of 2 bytes. */
  WebGL["VALUE_ALIGN_1"] = 0x000080;
  /** Value alignment of 4 bytes. */
  WebGL["VALUE_ALIGN_2"] = 0x000100;
  /** Value alignment of 8 bytes. */
  WebGL["VALUE_ALIGN_3"] = 0x000200;
  /** Value alignment of 16 bytes. */
  WebGL["VALUE_ALIGN_4"] = 0x000400;
  /** Value is a signed type. */
  WebGL["VALUE_SIGNED"] = 0x000800;
  /** Value is a float type. */
  WebGL["VALUE_FLOAT"] = 0x001000;
  /** Value type is nullable. */
  WebGL["VALUE_NULLABLE"] = 0x002000;
  /** Value type is managed. */
  WebGL["VALUE_MANAGED"] = 0x004000;
  /** Key alignment of 1 byte. */
  WebGL["KEY_ALIGN_0"] = 0x008000;
  /** Key alignment of 2 bytes. */
  WebGL["KEY_ALIGN_1"] = 0x010000;
  /** Key alignment of 4 bytes. */
  WebGL["KEY_ALIGN_2"] = 0x020000;
  /** Key alignment of 8 bytes. */
  WebGL["KEY_ALIGN_3"] = 0x040000;
  /** Key alignment of 16 bytes. */
  WebGL["KEY_ALIGN_4"] = 0x080000;
  /** Key is a signed type. */
  WebGL["KEY_SIGNED"] = 0x100000;
  /** Key is a float type. */
  WebGL["KEY_FLOAT"] = 0x200000;
  /** Key type is nullable. */
  WebGL["KEY_NULLABLE"] = 0x400000;
  /** Key type is managed. */
  WebGL["KEY_MANAGED"] = 0x800000;

  //imageArray
  WebGL["createImage"] = (image_location) => {
  ...
  WebGL["getView"] = (alignLog2, signed, float) => {
  ...
  WebGL["createContextFromCanvas"] = (canvas_id, context_type) => {
  ...
  */
  ...
  WebGL["compressedTexImage2D"] = (ctx, target, level, internalformat, width, height, border, data) => {
  ...
  WebGL["compressedTexSubImage2D"] = (ctx, target, level, xoffset, yoffset, width, height, format, data) => {
  ...
  WebGL["copyTexImage2D"] = (ctx, target, level, internalformat, x, y, width, height, border) => {
  ...
  WebGL["copyTexSubImage2D"] = (ctx, target, level, xoffset, yoffset, x, y, width, height) => {
  ...
  WebGL["deleteFramebuffer"] = (ctx, frame_buffer) => {
    try {
  ...
  WebGL["deleteRenderbuffer"] = (ctx, render_buffer) => {
    try {
  ...
  WebGL["deleteTexture"] = (ctx, texture) => {
    try {
  ...
  WebGL["depthFunc"] = (ctx, func) => { // func is a depth function enumeration
    try {
  ...
  WebGL["depthRange"] = (ctx, zNear, zFar) => {
    try {
  ...
  WebGL["detachShader"] = (ctx, program, shader) => {
    try {
  ...
  WebGL["disableVertexAttribArray"] = (ctx, index) => {
    try {
  ...
  WebGL["drawArrays"] = (ctx, mode, first, count) => {
    try {
  ...
  WebGL["drawElements"] = (ctx, mode, count, typ, offset) => {
    try {
  ...
  WebGL["enableVertexAttribArray"] = (ctx, index) => {
  ...
  WebGL["framebufferRenderbuffer"] = (ctx, target, attachment, renderbuffertarget, renderbuffer) => {
    try {
  ...
  WebGL["framebufferTexture2D"] = (ctx, target, attachment, textarget, texture, level) => {
    try {
  ...
  WebGL["generateMipmap"] = (ctx, target) => {
    try {
  ...
  WebGL["getActiveAttrib"] = (ctx, program, index) => {
  ...
  WebGL["getActiveUniform"] = (ctx, program, index) => {
    // will this return an externref?  How do I move in the data
  ...
  WebGL["getAttachedShaders"] = (ctx, program) => {
  ...
  WebGL["getAttribLocation"] = (ctx, program, name) => {
  ...
  WebGL["getBufferParameter"] = (ctx, target, pname) => {
    try {
  ...
  WebGL["getFramebufferAttachmentParameter"] = (ctx, target, attachment, pname) => {
    try {
  ...
  WebGL["getProgramInfoLog"] = (ctx, program) => {
  ...
  WebGL["getRenderbufferParameter"] = (ctx, target, pname) => {
    try {
  ...
  WebGL["getShaderParameter"] = (ctx, shader, pname) => {
    alert("getShaderParameter not implemented");
    return 0;
  }

  WebGL["getShaderPrecisionFormat"] = (ctx, shadertype, precisiontype) => {
    alert("getShaderPrecisionFormat not implemented");
    return 0;
  }

  WebGL["getShaderInfoLog"] = (ctx, shader) => {
    alert("getShaderInfoLog not implemented");
    return 0;
  }

  WebGL["getShaderSource"] = (ctx, shader) => {
    // this needs to return a string to AS
    alert("getShaderInfoLog not implemented");
    return 0;
  }

  WebGL["getTexParameter"] = (ctx, target, pname) => {
    alert("getTexParameter not implemented");
    return 0;
  }

  WebGL["getUniform"] = (ctx, program, location) => {
    // this can return multiple types
    alert("getUniform not implemented");
    return 0;
  }

  WebGL["getUniformLocation"] = (ctx, program, name) => {
  ...
  WebGL["getVertexAttrib"] = (ctx, index, pname) => {
    // this can return multiple types
  ...
  WebGL["getVertexAttribOffset"] = (ctx, index, pname) => {
    try {
  ...
  WebGL["isFramebuffer"] = (ctx, framebuffer) => {
    try {
  ...
  WebGL["isRenderbuffer"] = (ctx, renderbuffer) => {
    try {
  ...
  WebGL["pixelStorei"] = (ctx, pname, param) => {
    WebGL["contextArray"][ctx]["pixelStorei"](pname, param);
  }

  // ???
  WebGL["polygonOffset"] = (ctx, factor, units) => {
    try {
  ...
  WebGL["readPixels"] = (ctx, x, y, width, height, format, typ, pixels) => {
    alert("readPixels not implemented");
  }

  // create and initialize a renderbuffer object's data store
  WebGL["renderbufferStorage"] = (ctx, target, internalformat, width, height) => {
    try {
  ...
  WebGL["sampleCoverage"] = (ctx, value, invert) => {
    try {
  ...
  WebGL["scissor"] = (ctx, x, y, width, height) => {
    try {
  ...
  WebGL["shaderSource"] = (ctx, shader, source) => {
  ...
  WebGL["stencilFunc"] = (ctx, func, ref, mask) => {
    try {
  ...
  WebGL["stencilFuncSeparate"] = (ctx, face, func, ref, mask) => {
    try {
  ...
  WebGL["stencilMaskSeparate"] = (ctx, face, mask) => {
    try {
  ...
  WebGL["stencilOp"] = (ctx, fail, zfail, zpass) => {
    alert("stencilOp is not implemented");
  }

  // PROBLEM: zfail is a function
  WebGL["stencilOpSeparate"] = (ctx, face, fail, zfail, zpass) => {
    alert("stencilOpSeparate is not implemented");
  }

  // specify a two-dimensional texture image
  WebGL["texImage2D"] = (ctx, target, level, internalformat, format, typ, image_id) => {
  ...
  WebGL["texParameterf"] = (ctx, target, pname, param) => {
    try {
  ...
  WebGL["texParameteri"] = (ctx, target, pname, param) => {
  ...
  WebGL["uniform1f"] = (ctx, location, x) => {
    try {
  ...
  WebGL["uniform1fv"] = (ctx, location, v) => {
    try {
  ...
  WebGL["uniform2f"] = (ctx, location, x, y) => {
    try {
  ...
  WebGL["uniform2fv"] = (ctx, location, v) => {
    try {
  ...
  WebGL["uniform2i"] = (ctx, location, x, y) => {
    try {
  ...
  WebGL["uniform2iv"] = (ctx, location, v) => {
    try {
  ...
  WebGL["uniform3f"] = (ctx, location, x, y, z) => {
    try {
  ...
  WebGL["uniform3fv"] = (ctx, location, v) => {
    try {
      //Float32Array
  ...
  WebGL["uniform3i"] = (ctx, location, x, y, z) => {
    try {
  ...
  WebGL["uniform3iv"] = (ctx, location, v) => {
    try {
  ...
  WebGL["uniform4f"] = (ctx, location, x, y, z, w) => {
    try {
  ...
  WebGL["uniform4fv"] = (ctx, location, v) => {
    try {
  ...
  WebGL["uniform4i"] = (ctx, location, x, y, z, w) => {
    try {
  ...
  WebGL["uniform4iv"] = (ctx, location, v) => {
    try {
  ...
  WebGL["uniformMatrix2fv"] = (ctx, location, transpose, value_arr) => {
    try {
      const buffer = WebGL["memory"]["buffer"];
  ...
  WebGL["uniformMatrix3fv"] = (ctx, location, transpose, value_arr) => {
    try {
      const buffer = WebGL["memory"]["buffer"];
      let start_pos = value_arr >> 2;
  ...
  WebGL["uniformMatrix4fv"] = (ctx, location, transpose, value_arr) => {
    try {
      const buffer = WebGL["memory"]["buffer"];
      let start_pos = value_arr >> 2;
      return WebGL["contextArray"][ctx]["uniformMatrix3fv"](WebGL["uniformLocationArray"][location], transpose,
  ...
  WebGL["useProgram"] = (ctx, program) => {
    WebGL["contextArray"][ctx]["useProgram"](WebGL["programArray"][program]);
  }

  WebGL["validateProgram"] = (ctx, program) => {
    try {
  ...
  WebGL["vertexAttrib1f"] = (ctx, indx, x) => {
    try {
  ...
  WebGL["vertexAttrib1fv"] = (ctx, indx, v) => {
    try {
  ...
  WebGL["vertexAttrib2f"] = (ctx, indx, x, y) => {
    try {
  ...
  WebGL["vertexAttrib2fv"] = (ctx, indx, v) => {
    try {
  ...
  WebGL["vertexAttrib3f"] = (ctx, indx, x, y, z) => {
    try {
  ...
  WebGL["vertexAttrib3fv"] = (ctx, indx, v) => {
    try {
  ...
  WebGL["vertexAttrib4f"] = (ctx, indx, x, y, z, w) => {
    try {
  ...
  WebGL["vertexAttrib4fv"] = (ctx, indx, v) => {
    try {
  ...
  WebGL["vertexAttribPointer"] = (ctx, indx, size, typ, normalized, stride, offset) => {
    WebGL["contextArray"][ctx]["vertexAttribPointer"](indx, size, typ, normalized, stride, offset);
  }

  WebGL["viewport"] = (ctx, indx, x, y, width, height) => {
    try {
  ...
  // experimental WebGL2
  WebGL["copyBufferSubData"] = (ctx, readTarget, writeTarget, readOffset, writeOffset, size) => {
    alert("copyBufferSubData not implemented (experimental)");
  }

  // experimental WebGL2
  WebGL["getBufferSubData"] = (ctx, target, srcByteOffset, dstBuffer, dstOffset, length) => {
    alert("getBufferSubData not implemented (experimental)");
  }

  // experimental WebGL2
  WebGL["blitFramebuffer"] = (ctx, srcX0, srcY0, srcX1, srcY1,
    dstX0, dstY0, dstX1, dstY1,
    mask, filter) => {
    alert("blitFramebuffer not implemented (experimental)");
  }

  // experimental WebGL2
  WebGL["framebufferTextureLayer"] = (ctx, target, attachment, texture, level, layer) => {
    alert("framebufferTextureLayer not implemented (experimental)");
  }

  // experimental WebGL2
  WebGL["invalidateFramebuffer"] = (ctx, target, attachments) => {
    alert("invalidateFramebuffer not implemented (experimental)");
  }

  // experimental WebGL2
  WebGL["invalidateSubFramebuffer"] = (ctx, target, attachments, x, y, width, height) => {
    alert("invalidateSubFramebuffer not implemented (experimental)");
  }

  // experimental WebGL2
  WebGL["readBuffer"] = (ctx, src) => {
    alert("readBuffer not implemented (experimental)");
  }

  // experimental WebGL2
  WebGL["getInternalformatParameter"] = (ctx, target, internalformat, pname) => {
    alert("getInternalformatParameter not implemented (experimental)");
  }

  // experimental WebGL2
  WebGL["renderbufferStorageMultisample"] = (ctx, target, samples, internalformat, width, height) => {
    alert("renderbufferStorageMultisample not implemented (experimental)");
  }

  // experimental WebGL2
  WebGL["texStorage2D"] = (ctx, target, levels, internalformat, width, height) => {
    alert("texStorage2D not implemented (experimental)");
  }

  // experimental WebGL2
  WebGL["texStorage3D"] = (ctx, target, levels, internalformat, width, height, depth) => {
    alert("texStorage3D not implemented (experimental)");
  }

  // experimental WebGL2
  WebGL["texSubImage3D"] = (ctx, target, level, xoffset, yoffset, zoffset,
    width, height, depth, format, typ, pboOffset) => {
    alert("texSubImage3D not implemented (experimental)");
  }

  // experimental WebGL2
  WebGL["copyTexSubImage3D"] = (ctx, target, level, xoffset, yoffset, zoffset, x, y, width, height) => {
    alert("copyTexSubImage3D not implemented (experimental)");
  }

  // experimental WebGL2
  WebGL["compressedTexImage3D"] = (ctx, target, level, internalformat, width,
    height, depth, border, imageSize, offset) => {
    alert("compressedTexImage3D not implemented (experimental)");
  }

  // experimental WebGL2
  WebGL["compressedTexSubImage3D"] = (ctx, target, level, xoffset, yoffset, zoffset,
    width, height, depth, format, imageSize, offset) => {
    alert("compressedTexSubImage3D not implemented (experimental)");

  }

  // experimental WebGL2
  WebGL["getFragDataLocation"] = (ctx, program, name) => {
    alert("getFragDataLocation not implemented (experimental)");

  }

  // experimental WebGL2
  WebGL["uniform1ui"] = (ctx, location, v0) => {
    alert("uniform1ui not implemented (experimental)");

  }

  // experimental WebGL2
  WebGL["uniform2ui"] = (ctx, location, v0, v1) => {
    alert("uniform2ui not implemented (experimental)");

  }

  // experimental WebGL2
  WebGL["uniform3ui"] = (ctx, location, v0, v1, v3) => {
    alert("uniform3ui not implemented (experimental)");

  }

  // experimental WebGL2
  WebGL["uniform4ui"] = (ctx, location, v0, v1, v3, v4) => {
    alert("uniform4ui not implemented (experimental)");

  }

  // experimental WebGL2
  WebGL["uniform1uiv"] = (ctx, location, data, srcOffset, srcLength) => {
    alert("uniform1uiv not implemented (experimental)");

  }

  // experimental WebGL2
  WebGL["uniform2uiv"] = (ctx, location, data, srcOffset, srcLength) => {
    alert("uniform2uiv not implemented (experimental)");

  }

  // experimental WebGL2
  WebGL["uniform3uiv"] = (ctx, location, data, srcOffset, srcLength) => {
    alert("uniform3uiv not implemented (experimental)");

  }

  // experimental WebGL2
  WebGL["uniform4uiv"] = (ctx, location, data, srcOffset, srcLength) => {
    alert("uniform4uiv not implemented (experimental)");

  }

  // experimental WebGL2
  WebGL["uniformMatrix3x2fv"] = (ctx, location, transpose, data, srcOffset, srcLength) => {
    alert("uniformMatrix3x2fv not implemented (experimental)");
  }

  // experimental WebGL2
  WebGL["uniformMatrix4x2fv"] = (ctx, location, transpose, data, srcOffset, srcLength) => {
    alert("uniformMatrix4x2fv not implemented (experimental)");

  }

  // experimental WebGL2
  WebGL["uniformMatrix2x3fv"] = (ctx, location, transpose, data, srcOffset, srcLength) => {
    alert("uniformMatrix2x3fv not implemented (experimental)");

  }

  // experimental WebGL2
  WebGL["uniformMatrix4x3fv"] = (ctx, location, transpose, data, srcOffset, srcLength) => {
    alert("uniformMatrix4x3fv not implemented (experimental)");

  }

  // experimental WebGL2
  WebGL["uniformMatrix2x4fv"] = (ctx, location, transpose, data, srcOffset, srcLength) => {
    console.trace("uniformMatrix2x4fv");
    alert("uniformMatrix2x4fv not implemented (experimental)");
  }

  // experimental WebGL2
  WebGL["uniformMatrix3x4fv"] = (ctx, location, transpose, data, srcOffset, srcLength) => {
    console.trace("uniformMatrix3x4fv");
    alert("uniformMatrix3x4fv not implemented (experimental)");
  }

  // experimental WebGL2
  WebGL["vertexAttribI4i"] = (ctx, index, x, y, z, w) => {
    console.trace("vertexAttribI4i");
    alert("vertexAttribI4i not implemented (experimental)");
  }

  // experimental WebGL2
  WebGL["vertexAttribI4iv"] = (ctx, index, value_arr) => {
    console.trace("vertexAttribI4iv");
    alert("vertexAttribI4iv not implemented (experimental)");

  }

  // experimental WebGL2
  WebGL["vertexAttribI4ui"] = (ctx, index, x, y, z, w) => {
    console.trace("vertexAttribI4ui");
    alert("vertexAttribI4ui not implemented (experimental)");

  }

  // experimental WebGL2
  WebGL["vertexAttribI4uiv"] = (ctx, index, value_arr) => {
    console.trace("vertexAttribI4uiv");
    alert("vertexAttribI4uiv not implemented (experimental)");
  }

  // experimental WebGL2
  WebGL["vertexAttribIPointer"] = (ctx, index, size, typ, stride, offset) => {
    console.trace("vertexAttribIPointer");
    alert("vertexAttribIPointer not implemented (experimental)");
  }

  // experimental WebGL2
  WebGL["vertexAttribDivisor"] = (ctx, index, divisor) => {
    return WebGL["contextArray"][ctx]["vertexAttribDivisor"](ctx, index, divisor);
  }

  // experimental WebGL2
  WebGL["drawArraysInstanced"] = (ctx, mode, first, count, instanceCount) => {
    return WebGL["contextArray"][ctx]["drawArraysInstanced"](mode, first, count, instanceCount);
  }

  // experimental WebGL2
  WebGL["drawElementsInstanced"] = (ctx, mode, count, typ, offset, instanceCount) => {
    try {
  ...
  // experimental WebGL2
  WebGL["drawRangeElements"] = (ctx, mode, start, end, count, typ, offset) => {
    alert("drawRangeElements not implemented (experimental)");

  }

  // experimental WebGL2
  WebGL["drawBuffers"] = (ctx, buffers) => {
    alert("drawBuffers not implemented (experimental)");

  }

  // experimental WebGL2
  WebGL["clearBufferfv"] = (ctx, buffer, drawbuffer, values, srcOffset) => {
    alert("clearBufferfv not implemented (experimental)");

  }

  // experimental WebGL2
  WebGL["clearBufferiv"] = (ctx, buffer, drawbuffer, values, srcOffset) => {
    alert("clearBufferiv not implemented (experimental)");

  }

  // experimental WebGL2
  WebGL["clearBufferuiv"] = (ctx, buffer, drawbuffer, values, srcOffset) => {
    alert("clearBufferuiv not implemented (experimental)");

  }

  // experimental WebGL2
  WebGL["clearBufferfi"] = (ctx, buffer, drawbuffer, depth, stencil) => {
    alert("clearBufferfi not implemented (experimental)");

  }

  // experimental WebGL2
  WebGL["createQuery"] = (ctx) => {
    alert("createQuery not implemented (experimental)");

  }

  // experimental WebGL2
  WebGL["deleteQuery"] = (ctx, query) => {
    alert("deleteQuery not implemented (experimental)");

  }

  // experimental WebGL2
  WebGL["isQuery"] = (ctx, query) => {
    alert("isQuery not implemented (experimental)");

  }

  // experimental WebGL2
  WebGL["beginQuery"] = (ctx, target, query) => {
    alert("beginQuery not implemented (experimental)");

  }

  // experimental WebGL2
  WebGL["endQuery"] = (ctx, query) => {
    alert("endQuery not implemented (experimental)");

  }

  // experimental WebGL2
  WebGL["getQuery"] = (ctx, query, pname) => {
    alert("getQuery not implemented (experimental)");

  }

  // experimental WebGL2
  WebGL["getQueryParameter"] = (ctx, query, pname) => {
    alert("getQueryParameter not implemented (experimental)");

  }

  // experimental WebGL2
  WebGL["createSampler"] = (ctx) => {
    alert("createSampler not implemented (experimental)");

  }

  // experimental WebGL2
  WebGL["deleteSampler"] = (ctx, sampler) => {
    alert("deleteSampler not implemented (experimental)");

  }

  // experimental WebGL2
  WebGL["isSampler"] = (ctx, sampler) => {
    alert("isSampler not implemented (experimental)");

  }

  // experimental WebGL2
  WebGL["bindSampler"] = (ctx, uint, sampler) => {
    alert("bindSampler not implemented (experimental)");

  }

  // experimental WebGL2
  WebGL["samplerParameteri"] = (ctx, sampler, pname, param) => {
    alert("samplerParameteri not implemented (experimental)");

  }

  // experimental WebGL2
  WebGL["samplerParameterf"] = (ctx, sampler, pname, param) => {
    alert("samplerParameterf not implemented (experimental)");

  }

  // experimental WebGL2
  WebGL["getSamplerParameter"] = (ctx, sampler, pname) => {
    alert("getSamplerParameter not implemented (experimental)");

  }

  // experimental WebGL2
  WebGL["fenceSync"] = (ctx, condition, flags) => {
    alert("fenceSync not implemented (experimental)");

  }

  // experimental WebGL2
  WebGL["isSync"] = (ctx, sync) => {
    alert("isSync not implemented (experimental)");

  }

  // experimental WebGL2
  WebGL["deleteSync"] = (ctx, sync) => {
    alert("deleteSync not implemented (experimental)");

  }

  // experimental WebGL2
  WebGL["clientWaitSync"] = (ctx, sync, flags, timeout) => {
    alert("clientWaitSync not implemented (experimental)");

  }

  // experimental WebGL2
  WebGL["waitSync"] = (ctx, sync, flags, timeout) => {
    alert("waitSync not implemented (experimental)");

  }

  // experimental WebGL2
  WebGL["getSyncParameter"] = (ctx, sync, pname) => {
    alert("getSyncParameter not implemented (experimental)");

  }

  // experimental WebGL2
  WebGL["createTransformFeedback"] = (ctx) => {
    alert("createTransformFeedback not implemented (experimental)");

  }

  // experimental WebGL2
  WebGL["deleteTransformFeedback"] = (ctx, tf) => {
    alert("deleteTransformFeedback not implemented (experimental)");

  }

  // experimental WebGL2
  WebGL["isTransformFeedback"] = (ctx, tf) => {
    alert("isTransformFeedback not implemented (experimental)");

  }

  // experimental WebGL2
  WebGL["bindTransformFeedback"] = (ctx, target, tf) => {
    alert("bindTransformFeedback not implemented (experimental)");

  }

  // experimental WebGL2
  WebGL["beginTransformFeedback"] = (ctx, primitiveMode) => {
    alert("beginTransformFeedback not implemented (experimental)");

  }

  // experimental WebGL2
  WebGL["endTransformFeedback"] = (ctx) => {
    alert("endTransformFeedback not implemented (experimental)");

  }

  // experimental WebGL2
  WebGL["transformFeedbackVaryings"] = (ctx, program, varyings, bufferMode) => {
    alert("transformFeedbackVaryings not implemented (experimental)");

  }

  // experimental WebGL2
  WebGL["getTransformFeedbackVarying"] = (ctx, program, index) => {
    alert("getTransformFeedbackVarying not implemented (experimental)");

  }

  // experimental WebGL2
  WebGL["pauseTransformFeedback"] = (ctx) => {
    alert("pauseTransformFeedback not implemented (experimental)");

  }

  // experimental WebGL2
  WebGL["resumeTransformFeedback"] = (ctx) => {
    alert("resumeTransformFeedback not implemented (experimental)");

  }

  // experimental WebGL2
  WebGL["bindBufferBase"] = (ctx, target, index, buffer) => {
    alert("bindBufferBase not implemented (experimental)");

  }

  // experimental WebGL2
  WebGL["bindBufferRange"] = (ctx, target, index, buffer, offset, size) => {
    alert("bindBufferRange not implemented (experimental)");

  }

  // experimental WebGL2
  WebGL["getIndexedParameter"] = (ctx, target, index) => {
    alert("getIndexedParameter not implemented (experimental)");

  }

  // experimental WebGL2
  WebGL["getUniformIndices"] = (ctx, program, uniformNames) => {
    alert("getUniformIndices not implemented (experimental)");

  }

  // experimental WebGL2
  WebGL["getActiveUniforms"] = (ctx, program, uniformIndices, pname) => {
    alert("getActiveUniforms not implemented (experimental)");

  }

  // experimental WebGL2
  WebGL["getUniformBlockIndex"] = (ctx, program, uniformBlockName) => {
    alert("getUniformBlockIndex not implemented (experimental)");

  }

  // experimental WebGL2
  WebGL["getActiveUniformBlockParameter"] = (ctx, program, uniformBlockIndex, pname) => {
    alert("getActiveUniformBlockParameter not implemented (experimental)");

  }

  // experimental WebGL2
  WebGL["getActiveUniformBlockName"] = (ctx, program, uniformBlockIndex) => {
    alert("getActiveUniformBlockName not implemented (experimental)");

  }

  // experimental WebGL2
  WebGL["uniformBlockBinding"] = (ctx, program, uniformBlockIndex, uniformBlockBinding) => {
    alert("uniformBlockBinding not implemented (experimental)");

  }

  // experimental WebGL2
  WebGL["createVertexArray"] = (ctx) => {
  ...
  // experimental WebGL2
  WebGL["deleteVertexArray"] = (ctx, vertexArray) => {
    alert("deleteVertexArray not implemented (experimental)");

  }

  // experimental WebGL2
  WebGL["isVertexArray"] = (ctx, vertexArray) => {
    alert("isVertexArray not implemented (experimental)");

  }

  // experimental WebGL2
  WebGL["bindVertexArray"] = (ctx, vaoId) => {
